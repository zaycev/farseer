...
class Token(models.Model):
	...
	postag = models.CharField(max_length=64, null=False, blank=False, db_index=True)
	nertag = models.CharField(max_length=64, null=True, blank=True, db_index=True)
	text = models.CharField(max_length=256, null=False, blank=False, db_index=True)
	origin = models.CharField(max_length=256, null=True, blank=True, db_index=True)
